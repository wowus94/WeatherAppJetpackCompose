...
import ru.vlyashuk.weatherappjetpackcompose.R
...
import ru.vlyashuk.weatherappjetpackcompose.presentation.extensions.formattedFullDate
import ru.vlyashuk.weatherappjetpackcompose.presentation.extensions.formattedShortDayOfWeek
import ru.vlyashuk.weatherappjetpackcompose.presentation.extensions.tempToFormattedString
import ru.vlyashuk.weatherappjetpackcompose.presentation.ui.theme.Gradient
...
fun DetailsContent(
    ...
    Scaffold(
        ...
        modifier = Modifier
            .fillMaxSize()
            .background(Gradient.CardGradients.gradients[1].primaryGradient)
    ) { padding ->
